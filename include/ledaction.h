 ...
 * @file ledaction.h
 * 
 * @brief This file represents an LED action.
 * @version 0.1
 * @date 2021-06-15
 * 
...
#include "display.h"
using rgb_color = Display::rgb_color; 
...
class LEDAction {
  protected:
    ...
    char * message;
    bool preparedForWrite = false; //This is to let the action executer know if the action has finished running commands, and if it is now ready for update
  ...
  public:
    ...
    virtual void deconstruct_displayLEDs() {};
